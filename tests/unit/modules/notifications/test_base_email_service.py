...
def make_payload(**kwargs) -> EmailPayload:
    defaults = dict(
...
class TestPrepareMessage:
    def test_subject_and_recipients_are_set(self, users_email_service: UsersEmailService):
    ...
    def test_optional_fields_default_to_empty(self, users_email_service: UsersEmailService):
    ...
    def test_cc_bcc_reply_to_are_forwarded(self, users_email_service: UsersEmailService):
        payload = make_payload(
            cc=["cc@example.com"],
            bcc=["bcc@example.com"],
